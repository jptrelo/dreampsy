	...
	/*Codigo daniel rebolledo*/
		...
		* */
        ...
        $('.btn_buho').click(function () {
			...
			$('#instruccio1').text(texto_sub.replace('p1', personaje1));
            
            //$('#instruccio1').show();

            $('#perso').html(personaje3);

            $('#persona_linea').attr('class','dreampsy');
            ho_talk = 1;
            //quitar_buho(20);
            $('.chats .chats_inner').append(' ' +'<span id="intruccion2" class="instruccion_buho buho_massage2">\n' +
                 texto_sub.replace('p2', personaje2)+
                '</span>');
            ...
            /*if(buho == 1){
				...
				if(lenguaje == 'EN'){
					...
					$('.chats .chats_inner span:last').prepend('<b>'+personaje2+' says:</b>');
				}else{
				...
				if(lenguaje == 'EN'){
					console.log('aqui hablo yo '+ peronnaje);
					$('.chats .chats_inner span:last').prepend('<b>'+personaje1+' says:</b>');
				}else{
        ...
        $('#sender').click(function () {
        	if(mensaje=='' || mensaje==' ' || mensaje=='   ' | mensaje=='    '){	
	        	...
	        	//poner_buho(demorado);
              	...
              	$('#texto1').hide();
			  	texto_sub = $('#sub_buho2').html();
			  	texto_sub = texto_sub.replace('p1', personaje1);
			  	texto_sub = texto_sub.replace('p2', personaje2);
              	texto_final = $('#txt2').html();
	            ...
	            if(buho == 1){
	                ...
	                poner_buho(demorado);
	                  $('#texto3').hide();
					  texto_sub = $('#sub_buho4').text();
					  texto_sub = texto_sub.replace('p1', personaje1);
					  texto_sub = texto_sub.replace('p1', personaje2);
					...
					$('#texto5').show();
					instru_text = $('#instruccion3').text();
					$('.texto_instruccion').text(instru_text);
					...
					$('#texto6').show();
					instru_text = $('#instruccion4').text();
					$('.texto_instruccion2').text(instru_text);
	                $('#instruccion_personaje2').delay(3500).fadeIn(100,function(){
	                	$(this).addClass('active');
	                })
	                $('#respuestas_p1').hide();
		...
		$('#secuencia_chat button').click(function () {
			console.log('#secuencia_chat button');
