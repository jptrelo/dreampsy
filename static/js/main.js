   ...
   $(".idioma").click(function () {
       ...
       $.ajax({
           ...
           success: function (data) {
                ...
                $('#state').text(data.parrafo8);
                $('#perso_linea').text(data.parrafo7);
                $('#texto8').text(data.pregunta_personaje);
                $('#sub_buho1').text(data.sub_buho1);
                $('#sub_buho2').text(data.sub_buho2);
                $('#sub_buho3').text(data.sub_buho3);
                $('#sub_buho4').text(data.sub_buho4);
                $('#sub_buho5').text(data.sub_buho5);
                $('#sub_buho6').text(data.sub_buho6);
                $('#instruccion3').text(data.instruccion_3);
                $('#instruccion4').text(data.instruccion_4);
                $('#instruccion5').text(data.instruccion_5);
                $('#instruccion6').text(data.instruccion_6);
                $('#instruccion7').text(data.instruccion_7);
